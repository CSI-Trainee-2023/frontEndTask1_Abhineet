  ...
  return (
    ...
    <div className='footContainer'>
        <div className="footBrand">
            ...
            <p className='brandContent'>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor.</p>
            <p>121 king street, Melbourne 3000<br></br>+12 3 0000 0000<br></br>contact@brandemail.com</p>
